...
<div id="allHolder">
    <div id="container">
		...
		<?php if ($this->session->userdata('logged_in')) : ?>
			...
			<li><?php echo anchor('invoices/duplicate/'.$row->id, $this->lang->line('menu_duplicate_invoice'), ['class' => 'invduplicate']); ?></li>

			<li><?php echo anchor('invoices/delete/'.$row->id, $this->lang->line('menu_delete_invoice'), ['class' => 'lbOn deleteConfirm']); ?></li>
