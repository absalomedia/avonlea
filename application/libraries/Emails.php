...
class Emails
{
    ...
    public static function registration($customer)
    {
    ...
    public static function giftCardNotification($giftCard)
    {
        $email = \Swift_Message::newInstance();
    ...
    */
    public static function resetPassword($password, $adminEmail)
    {
        $email = \Swift_Message::newInstance();
    ...
    */
    public static function resetPasswordCustomer($password, $customeEmail)
    {
        $email = \Swift_Message::newInstance();
