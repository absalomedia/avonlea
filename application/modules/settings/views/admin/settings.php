...
<?php echo form_open_multipart('admin/settings'); ?>
    ...
    <fieldset>
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align:right;">
                        ...
                        <button type="button" class="btn btn-success" onclick="add_status()"><i class="fa fa-plus" aria-hidden="true"></i></button>
                        </div>
                        </div>
                    </th>
                </tr>
        ...
        <?php echo form_textarea(['name' => 'order_statuses', 'value' => assign_value('order_statuses', $order_statuses), 'id' => 'order_statuses_json']); ?>
