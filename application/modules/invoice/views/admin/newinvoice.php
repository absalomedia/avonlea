...
<?php if ($row->tax_status) :?>
  <p><?php echo $tax1_desc; ?> (<?php echo $tax1_rate; ?>%) <?php echo \CI::Settings()->getSettings('currency_symbol'); ?><span id="item_tax1amount">0.00</span></p>
    <?php if ($tax2_rate != 0) :?>
